...
s3 = aws_session = boto3.Session('AKIAZXDZRFQVP24YW7UU', '32hOmVzUovuSW89PjoSYS2WNBm3IE/JKyosYehQh')
data = open('uqi/result/static/result/pdf/marksheets/1/1st/ARB_1_1_21_0.pdf', 'rb')
s3.Bucket('uqhs').put_object(Key='file_name.txt', Body=my_file)
# test listing
